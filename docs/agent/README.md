...
Express API остается владельцем всей media-логики: `yt-dlp`, `ffmpeg`, Whisper-движки, uploads, SSE progress, YouTube video backlog, транскрипты видео, скачивание видео, сжатие локальных видео и screenshot/Markdown artifacts. Runtime-файлы лежат в корневой папке `runtime/`: `runtime/source/`, `runtime/tmp/`, `runtime/artifacts/`, `runtime/downloads/`, `runtime/compressed/` и `runtime/obsidian/`.
